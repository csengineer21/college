...
class home implements ActionListener
{
	...
	public void actionPerformed (ActionEvent ae)
	{
		if(ae.getSource() == m11)
		{
                    ...
                    l2=new JLabel("<html><body>The Modern Institute of Technology (RTU College ) embarked on its mission in the field of Technical Education . <br> It is situated on a prominent location at Jakhera Village 6th mile stone alwar.<br>  The Institute campus is decent,clean.<br>ABESIT Campus have air-conditioned rooms and tutorial rooms, ultra modern Auditorium and Seminar Hall with audio-visual aids.<br>Institute possesses proper playgrounds and hard courts for outdoor sports.<br>Separate decent boys and girls hostels with mess facility have attracted the attention of students.<br> The faculty residence in campus provide sense of security to hostelers, besides strict security monitoring 24X7.<br>  State-of-art Library with reading room provides teaching learning atmosphere in the campus.<br>  Campus houses Stationery Shop, Snacks Café, Laundry Shop.  The teaching faculty of the institute is qualified, competent and painstaking.</body></html>");
                    p1.add(l2);
