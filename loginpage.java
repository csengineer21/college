...
class loginpage implements ActionListener
{
	...
	public void actionPerformed (ActionEvent ae)
	{
		...
		if(ae.getSource()==b1)
		{
			...
			else if (s1.equalsIgnoreCase("Student") && s2.equalsIgnoreCase("Mubin") && s3.equals("123"))
			{
				JOptionPane.showMessageDialog(f1,"Student login success");
                                home hh=new home();
			}
			else if (s1.equalsIgnoreCase("Instructor") && s2.equalsIgnoreCase("Manisha") && s3.equals("789"))
			{
